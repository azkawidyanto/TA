...
public class Main {
    ...
    public static PredicatedBugSignature analyze( String filePath,  Integer k,  Integer negSup,
             Double DSLimit,  Integer sizeLimit,  boolean isDebug) {
        ...
        System.out.println();
         ...
         PredicatedBugSignature predicatedBugSignature = MineSignatures.mine(fullDatabase, fullDatabase, k, negSup,
                sizeLimit);
        System.out.println();
